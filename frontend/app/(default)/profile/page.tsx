...
export default function FuturisticProfile() {
    ...
    return (
        <div className="min-h-screen  text-zinc-100 p-4 md:p-10 font-mono tracking-tight">
            {/* Background Glow */}
                        ...
                        <div className="p-8 flex flex-col md:flex-row items-center gap-10 relative z-10">
                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    {/* <span className="bg-zinc-800/50 border border-zinc-700 px-3 py-1 text-[11px] uppercase font-bold text-zinc-400">
